      ...
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xl:col-span-9 2xl:col-span-9 z-10">
          ...
          <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
            ...
            >
              ...
              <div class="2xl:flex mt-5 mb-3">
                ...
                >
                  <Tippy
                    tag="div"
                    class="font-medium inline-flex bg-theme-10 text-white rounded-full px-2 py-1 text-xs 2xl:text-sm 2xl:p-0 2xl:text-theme-10 2xl:bg-transparent 2xl:flex items-center cursor-pointer 2xl:justify-center"
            ...
            >
              <div
                class="boxed-tabs nav nav-tabs justify-center w-3/4 2xl:w-4/6 bg-theme-7 bg-opacity-50 text-gray-600 dark:bg-dark-2 dark:text-gray-500 rounded-md p-1 mx-auto"
                role="tablist"
              >
                <a
                  id="active-users-tab"
