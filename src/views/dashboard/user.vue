      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
          <div class="intro-y flex items-center h-10">
            <h2 class="text-lg font-medium truncate mr-5">{{$t('dashboard_user.title1')}}</h2>
            <a
              href="javascript:;"
            ...
            <div class="col-span-12 sm:col-span-12 xl:col-span-6 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  ...
                  <div class="text-base text-gray-600 mt-1">{{$t('dashboard_user.register_pc')}}</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-12 xl:col-span-6 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="ml-auto">
                      <div class="text-3xl font-medium leading-8">
                    <span v-if="volume_customer">{{number(volume_customer.register_baleqty)}}</span>
                    <span v-else>0</span>
                  </div>
                    </div>
                  </div>

                  <div class="text-base text-gray-600 mt-1">{{$t('dashboard_user.register_bc')}}</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-12 xl:col-span-6 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="ml-auto">
                      <div class="text-3xl font-medium leading-8">
                    <span v-if="volume_customer">{{number(volume_customer.register_pino)}}</span>
                    <span v-else>0</span>
                  </div>
                    </div>
                  </div>

                  <div class="text-base text-gray-600 mt-1">{{$t('dashboard_user.pi_qty')}}</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-12 xl:col-span-6 intro-y">
              <div class="report-box zoom-in">
                <div class="box p-5">
                  <div class="flex">
                    ...
                    <div class="ml-auto">
                      <div class="text-3xl font-medium leading-8">
                    <span v-if="volume_customer">{{number(volume_customer.baleqty_inprogress)}}</span>
                    <span v-else>0</span>
                  </div>
                    </div>
                  </div>

                  <div class="text-base text-gray-600 mt-1">{{$t('dashboard_user.bc_inprogress')}}</div>
                </div>
              </div>
            </div>
          </div>
